...
export interface PromptTurnObject {
  ...
  content: string | object; // Content from the InputArea
...
export interface PromptControl {
  ...
  getParameters?: () => Record<string, any> | null | Promise<Record<string, any> | null>;
  getMetadata?: () => Record<string, any> | null | Promise<Record<string, any> | null>;
  // Middleware modifies the PromptTurnObject before it's finalized by PromptWrapper
  middleware?: (turnData: PromptTurnObject) => PromptTurnObject | Promise<PromptTurnObject>;
  onClick?: () => void;
  order?: number;
  clearOnSubmit?: () => void;
}
