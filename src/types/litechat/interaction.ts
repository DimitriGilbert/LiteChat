...
import type { InteractionStatus, Metadata } from './common';

export type InteractionType =
  | 'message.user_assistant' | 'message.assistant_regen' | 'message.user_edit'
  | 'conversation.title_generation' | 'tool.execution'
