...
const LCErrorIcon = (props: LucideProps) => {
  ...
  return (
    <svg
      ...
      {...rest}
    >
      {/* Main robot head/body (from LiteChatIcon) */}
      <g
...
304 234 273 247 286 277 283 32 -3 32 -3 31 -58z"
      ...
      <g transform="translate(165, 220) scale(2.5)">
        <path d="M5 5l14 14" stroke={color} strokeWidth="4" />
        <path d="M18 5l-14 14" stroke={color} strokeWidth="4" />
      </g>
      ...
      >
        <path
          d="M2147 1750 c-26 15 -48 65 -41 94
